 ...
 * 五星好评label
 */
public class FiveStarRatingLabelTest extends JPanel {
	private FiveStarRatingLabelTest() {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(FiveStarRatingLabelTest::createAndShowGui);
	}
	...
	private static void createAndShowGui() {
		...
		frame.getContentPane().add(new FiveStarRatingLabelTest());
		frame.pack();
