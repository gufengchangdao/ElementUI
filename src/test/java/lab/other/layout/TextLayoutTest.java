 ...
 * 文本绘制的相关参数
 */
public class TextLayoutTest extends JPanel {
	private TextLayoutTest() {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(TextLayoutTest::createAndShowGui);
	}
	...
	private static void createAndShowGui() {
		...
		frame.getContentPane().add(new TextLayoutTest());
		frame.pack();
